...
class Wpshop_Payment
{
    ...
    $i = 11;
		...
		$this->payments[$i]->fields = array("Order".'$#$hidden$#$0$#$0$#$0$#$0$#$0',
						   ...
						   __('E-mail', 'wp-shop').'$#$textfield$#$0$#$1$#$0$#$0$#$0', // E-mail
						   __('Comment to the order', 'wp-shop').'$#$textarea$#$0$#$0$#$0$#$0$#$0');
		$this->payments[$i]->picture = 'sofortbanking.png';
    ...
    $i = 12;
		...
		$this->payments[$i]->name = "Yandex Money";
		$this->payments[$i]->fields = array("Order".'$#$hidden$#$0$#$0$#$0$#$0$#$0',
						   ...
						   __('E-mail', 'wp-shop').'$#$textfield$#$0$#$1$#$0$#$0$#$0', // E-mail
						   __('Comment to the order', 'wp-shop').'$#$textarea$#$0$#$0$#$0$#$0$#$0');
		$this->payments[$i]->picture = 'yandexmoney.png';
		$this->payments[$i]->textAfterSend = '<h3>'.__('To pay your order, click the button above . <br/> After your payment, we will get data of your payment and our manager will contact you to arrange the delivery. <br/> Thank you for using our service!', 'wp-shop').'</h3>'; // Для оплаты Вашего заказа нажмите кнопку выше 'Оплатить'.<br/>После совершения Вами оплаты заказа информация передается нам, и наш менеджер обязательно свяжется с Вами для уточнения деталей доставки.<br/>Благодарим, что воспользовались нашим сервисом!
	...
	$i = 13;
		...
		$this->payments[$i]->name = "Sberbank online";
		$this->payments[$i]->fields = array("Order".'$#$hidden$#$0$#$0$#$0$#$0$#$0',
						   ...
						   __('E-mail', 'wp-shop').'$#$textfield$#$0$#$1$#$0$#$0$#$0', // E-mail
						   __('Comment to the order', 'wp-shop').'$#$textarea$#$0$#$0$#$0$#$0$#$0');
		$this->payments[$i]->picture = 'sberbank.png';
